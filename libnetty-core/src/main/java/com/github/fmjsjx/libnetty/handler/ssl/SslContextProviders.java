...
public class SslContextProviders {
     ...
     */
    public static SslContextProvider selfSignedForServer() throws SSLRuntimeException {
     ...
     * @since 4.1
     */
    public static SslContextProvider selfSignedForServer(X509Bundle x509Bundle) throws SSLRuntimeException {
    ...
    private static SslContextBuilder chooseProvider(SslContextBuilder builder) {
     ...
     */
    public static SslContextProvider forServer(File keyCertChainFile, File keyFile) throws SSLRuntimeException {
     ...
     */
    public static SslContextProvider forServer(File keyCertChainFile, File keyFile, String keyPassword)
     ...
     */
    public static SslContextProvider watchingForServer(File keyCertChainFile, File keyFile)
     ...
     * @throws IOException         if any IO error occurs
     */
    public static SslContextProvider watchingForClient(File keyCertChainFile, File keyFile)
            throws SSLRuntimeException, IOException {
    ...
    private static SslContextProvider factoryForServer(File keyCertChainFile, File keyFile, String keyPassword) {
        return () -> {
    ...
    private static SslContextProvider factoryForClient(File keyCertChainFile, File keyFile, String keyPassword) {
        return () -> {
     ...
     * @throws SSLRuntimeException if any SSL error occurs
     */
    public static SslContextProvider insecureForClient() throws SSLRuntimeException {
     ...
     * @throws SSLRuntimeException if any SSL error occurs
     */
    public static SslContextProvider forClient(File trustCertCollectionFile) throws SSLRuntimeException {
     ...
     * @return a {@code SslContextProvider}
     */
    public static SslContextProvider simple(SslContext sslContext) {
        return () -> sslContext;
    }
     ...
     * @since 2.0
     */
    public static PermutableSslContextProvider permutable(SslContext sslContext) {
     ...
     * @since 4.1
     */
    public static SslContextProvider selfSignedForH2Server() throws SSLRuntimeException {
     ...
     * @since 4.1
     */
    public static SslContextProvider selfSignedForH2Server(X509Bundle x509Bundle) throws SSLRuntimeException {
     ...
     * @since 4.1
     */
    public static SslContextProvider forH2Server(File keyCertChainFile, File keyFile) throws SSLRuntimeException {
     ...
     * @since 4.1
     */
    public static SslContextProvider forH2Server(File keyCertChainFile, File keyFile, String keyPassword)
            throws SSLRuntimeException {
