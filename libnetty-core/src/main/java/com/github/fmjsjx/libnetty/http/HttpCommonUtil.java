...
public final class HttpCommonUtil {
     ...
     */
    public static String remoteAddress(Channel channel, HttpHeaders headers) {
     ...
     */
    public static AsciiString contentType(AsciiString contentType) {
     ...
     * @return a {@code AsciiString}
     */
    public static AsciiString contentType(AsciiString contentType, Charset charset) {
     ...
     */
    public static CharSequence basicAuthentication(String user, String password) {
