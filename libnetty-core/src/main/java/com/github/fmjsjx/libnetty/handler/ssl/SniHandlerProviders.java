...
public class SniHandlerProviders {
     ...
     */
    public static SniHandlerProvider create(Mapping<? super String, ? extends SslContext> mapping) {
     ...
     * @return a {@code SniHandlerProvider}
     */
    public static SniHandlerProvider create(SslContext defaultSslContext, Map<String, SslContext> mapping) {
     ...
     */
    public static PermutableSniHandlerProvider permutable(Mapping<? super String, ? extends SslContext> mapping) {
