  ...
  <dependencyManagement>
    <dependencies>
      ...
      <dependency>
        ...
        <version>4.3.0-RC3-SNAPSHOT</version>
        <type>pom</type>
        <scope>import</scope>
      </dependency>
    </dependencies>
...
dependencies {
    // BOM
    implementation platform('com.github.fmjsjx:libnetty-bom:4.3.0-RC3-SNAPSHOT')
    // HTTP server
...
The [`libnetty-core`](libnetty-core) module provides additional features for Netty4.
