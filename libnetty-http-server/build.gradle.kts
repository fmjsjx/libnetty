...
dependencies {
    ...
    compileOnly("io.netty:netty-transport-native-io_uring::linux-x86_64")
    compileOnly("io.netty:netty-transport-native-epoll::linux-x86_64")
    compileOnly("io.netty:netty-transport-native-kqueue::osx-x86_64")
